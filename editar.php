...
<div class="caja_popup2" id="formmodificar">
  <form method="POST" class="contenedor_popup" >
		...
		<tr><th colspan="2">Modificar usuario</th></tr>
            ...
            <tr> 
                <td>Clave</td>
                <td><input type="text" name="txtclave" value="<?php echo $clave;?>" required></td>
            </tr>
            <tr> 
                <td>Teléfono</td>
...
{    
    ...
    $querymodificar = mysqli_query($conn, "UPDATE usuarios SET nom='$nombre1',correo='$correo1',clave='$clave1',tel='$telefono1' WHERE cod=$codigo1");
